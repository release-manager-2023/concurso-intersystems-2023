...
public class ProductVersionDeliveryPromoteResource {
	...
	public Response changeVersionStatus(ChangeProductVersionDeliveryDTO changeVersionDTO) {
		return Response.ok(versionService.promoteVersion(changeVersionDTO)).build();
	}
}
